...
Generated by Repomix on: 2025-04-11T09:33:04.201Z
...
.tr-closed>.tr-entry>.tr-expander::before {
content: "▶";
}
...
const token = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]_"|'[^']_'/g
...
<body>
    ...
    <div id="shortcutr-text" class="text-box hidden">
    ...
    <div id="container">
        <div class="page">
            <div id="trestle">
                <div id="trestle-root" class="tr-root"></div>
            </div>
        </div>
    </div>
    ...
    <template id="entry-template">
        <div class="tr-entry">
            <button class="tr-expander" aria-label="Toggle expand"></button>
            <div class="tr-handle" aria-hidden="true">●⊤</div>
            <div class="tr-title" contenteditable="true"></div>
            <div class="tr-actions">
                <button class="tr-card" aria-label="Show card">📄</button>
                <button class="tr-addChild" aria-label="Add child">➕</button>
                <button class="tr-delete" aria-label="Delete">❌</button>
            </div>
