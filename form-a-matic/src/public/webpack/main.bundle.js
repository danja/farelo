...
var FormAMatic = {
  extract: _public_extractor_js__WEBPACK_IMPORTED_MODULE_0__.extract
};
if (typeof window !== 'undefined') {
  window.FormAMatic = FormAMatic;
  window.extract = _public_extractor_js__WEBPACK_IMPORTED_MODULE_0__.extract;
}
  ...
  return _createClass(DatasetBuilder, [{
    ...
    value: function build(data) {
      ...
      data.forEach(function (item) {
        ...
        if (item.entries) {
          _this.handleEntries(dataset, subject, predicate, item.entries);
        } else {
          var object = _this.nodeCreator.createNode(item);
          dataset.add(_this.rdf.quad(subject, predicate, object));
        }
      });
      return dataset;
    }
    ...
    key: "handleEntries",
    value: function handleEntries(dataset, subject, predicate, entries) {
      var _this2 = this;
      entries.forEach(function (entry) {
        var entrySubject = _this2.rdf.blankNode();
        dataset.add(_this2.rdf.quad(subject, predicate, entrySubject));
        var nestedDataset = _this2.build(Object.values(entry), entrySubject);
...
var FormDataExtractor = /*#__PURE__*/function () {
  ...
  return _createClass(FormDataExtractor, [{
    ...
    value: function extract(form) {
      ...
      var data = Array.from(elements).map(this.extractElementData);
...
var TurtleSerializer = /*#__PURE__*/function () {
  function TurtleSerializer(N3Writer) {
  ...
  return _createClass(TurtleSerializer, [{
    ...
    value: function serialize(dataset) {
      ...
      return new Promise(function (resolve, reject) {
        var writer = new _this4.N3Writer();
        var turtleString = '';
        writer["import"](dataset.toStream()).on('data', function (chunk) {
          turtleString += chunk;
        }).on('end', function () {
          return resolve(turtleString);
        }).on('error', reject);
      });
    }
  }]);
...
var RDFExtractor = /*#__PURE__*/function () {
  ...
  return _createClass(RDFExtractor, [{
    key: "extract",
    value: function () {
      var _extract = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(document) {
        var form, data, dataset;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              console.error('Extraction failed:', _context.t0);
              throw _context.t0;
            case 13:
            case "end":
...
var extractor = new RDFExtractor(rdf_ext__WEBPACK_IMPORTED_MODULE_0__["default"], _rdfjs_parser_n3__WEBPACK_IMPORTED_MODULE_1__["default"]);
var extract = function extract(document) {
